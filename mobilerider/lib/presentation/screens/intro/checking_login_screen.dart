...
class _CheckingLoginScreenState extends State<CheckingLoginScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (state is LoadingAuthState) {
      ...
      Navigator.pushAndRemoveUntil(context, routeFrave(page: IntroScreen()), (route) => false);
      ...
      child: Scaffold(
        backgroundColor: ColorsFrave.loadingColor,
        body: Column(
                ...
                builder: (context, child) 
                  => Transform.scale(
                    ...
                    child: SizedBox(
                      height: 200,
                      width: 200,
                      child: Image.asset('Assets/Logo/logobg.png'),
                    ),
                  ),
              ),
            )
